...
//    public String redirectLoginRequest(@PathVariable String socialLoginType, @RequestParam("redirect_uri") String redirectUri) {
...
//    @GetMapping("/api/v1/login/callback/{socialLoginType}")
//    public void callback(HttpServletResponse response, @PathVariable String socialLoginType, @RequestParam String code) throws Exception {
